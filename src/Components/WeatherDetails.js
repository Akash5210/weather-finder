    ...
    return ( 
        <div className="row mt-5 page1">
            ...
            <div className="col-md col-12 weather-image">
                <img src="http://www.noaa.gov/sites/default/files/styles/landscape_width_650/public/legacy/image/2019/Jun/iStock-477110708%20%281%29.jpg?itok=qLIDK-SD" className="" alt="..." />
            </div>
        </div>
    );
}